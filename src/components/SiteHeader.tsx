...
export function SiteHeader() {
  ...
  return (
    <div className="sticky top-0 z-50">
      <AnnouncementBar />
      <header className="border-b border-purple/10 bg-paper/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-content items-center justify-between gap-4 px-4 py-3 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            <span className="hidden rounded-md bg-ocean/10 px-3 py-1 text-xs font-semibold text-ocean sm:inline">
              🇺🇸 USA launch
            </span>
            <Link
              href="/cart"
              className="relative inline-flex items-center justify-center rounded-md bg-purple p-2.5 text-white shadow-brand transition hover:bg-purple-deep"
